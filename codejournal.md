...
### Collecting lineup from box score page
Wrote the **get_lineup()** function, using the **get_table()** function to get the lineups from the box score page. Helper function **compile_lineups()** uses **get_index()** and **list_index()** to filter starters and subs for each team and return a list containing both teams' starting lineups and substitutes list.
*lineup.py*
```python
