...
all_codes = [
    ...
    'flied into double play', 'flied into triple play', 'popped up',
    'popped out', 'popped into double play', 'popped into triple play',
    'lined into double play', 'lined into triple play', 'lined out',
    'struck out looking', 'struck out swinging', 'struck out', 'grounded out',
    'grounded into double play', 'hit into double play', 'hit into triple play',
    ...
    'reached first on a dropped fly ', 'reached on a dropped fly ',
    'reached on a fielders choice', 'reached on a fielders choice', 'indifference ',
    'reached on', 'singled', 'intentionally walked', 'walked', 'hit by pitch',
    'doubled', 'advanced to second', 'stole second', 'tripled', 'advanced to third',
    'stole third', 'homered', 'scored', 'stole home', 'grounded out',
